...
module app.services {
    ...
    interface IDeliverableDefinitionsModel extends ap.Model{
    ...
    export interface IDeliverableDefinition extends ap.ListItem {
        ...
        getDeliverablesForDefinition():Object;
    ...
    class DeliverableDefinition implements IDeliverableDefinition{
        dueDates;
        constructor(obj) {
            var self = this;
            _.extend(self, obj);
